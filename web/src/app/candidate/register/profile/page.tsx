    ...
    <div className='mx-auto max-w-2xl p-8'>
      <form
        ...
        <p className='mt-1 text-sm leading-6 text-gray-600'>
          To apply for some projects, please make sure that your information is
          complete
        </p>
        ...
        <h2 className='mt-10 text-xl'>Academical Data</h2>
        ...
        <button
          type='button'
          className='mt-6 rounded-lg bg-gray-100 px-4 py-2 text-sm font-semibold leading-6'>
          Add more education
        </button>

        <h2 className='mt-10 text-xl'>Technical Data</h2>
        ...
        <div className='sm:col-span-4'>
          ...
          <div className='mt-2'>
            <p className='text-xs text-gray-400'>
              Use comma-separated values to list the programming languages you
              know
            </p>
            <div className='flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600 sm:max-w-md'>
              <input
        ...
        <h2 className='mt-10 text-xl'>Experience</h2>
